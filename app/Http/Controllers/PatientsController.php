...
/******   Manage Users  Start ******/
        public function managePatients(){
			...
			$manageoppatients = DB::table('patients')->select('patients.*','patient_disease.*','patients.id as userID')
                ...
                ->where('patients.user_types_id', '=','3')->where('patients.status', '=','2')->orderBy('patients.id','Asc')->get();
            ...
            return view("patients.index")->with('manageoppatients', $manageoppatients)->with('manageippatients', $manageippatients)->with('managedoctor', $managedoctor)->with('managedistrict', $managedistrict);
        }
