 ...
 /******   Manage ph_products Start ******/
   ...
   /* public function manageph_prods(){
      ...
      public function manageProducts(){
        $shop_id = Auth::user()->shop_id;
        $manageproduct = DB::table('oc_product')->select('oc_product.*','oc_product_description.*')->Join('oc_product_description', 'oc_product.product_id', '=', 'oc_product_description.product_id')->orderBy('oc_product.product_id','Asc')->get();
      ...
      //echo "<pre>";print_r($manageproduct);echo "</pre>";die;
