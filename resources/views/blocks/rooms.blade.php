...
<td><?php echo $block_id = $manageroomlist->block_id; ?></td>
                        ...
                        @endif     
						 <td>
                           <button type="button" data-toggle="modal" data-target="#edit{{ $manageroomlist->id }}"  class="col-md-6 btn btn-block btn-info"><i class="fa fa-edit"></i></button>
                        </td>
						 <td>
						 <a href="{{ url('/beds')}}/{{ $manageroomlist->id }}" type="button"class="col-md-5 btn btn-block btn-info"><i class="fa fa-eye"> Beds</i></a>
