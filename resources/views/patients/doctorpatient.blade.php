...
<div class="modal fade" id="ipadmission{{ $manageoppatientslist->userID }}"  class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   <form action="{{url('/edit_patient')}}" method="post">
      {{ csrf_field() }}
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h4 class="modal-title">IP Admission</h4>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
               </div>
               <div class="modal-body">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group row">
                           <label for="profile_status" class="col-sm-4 col-form-label"><span style="color:red"></span>Patient Name</label>
                           <div class="col-sm-8">
                              <input  value="{{ $manageoppatientslist->profile_status }}.{{ $manageoppatientslist->full_name }}" required="required" type="text" class="form-control" name="full_name" id="full_name" disabled="disabled" maxlength="50" placeholder="Patient Full Name">
                           </div>
                        </div>
                        <div class="form-group row">
                           <label for="gender" class="col-sm-4 col-form-label"><span style="color:red"></span>Gender</label>
                           <div class="col-sm-8">
                               <input  value="{{ $manageoppatientslist->gender }}" required="required" type="text" class="form-control" name="gender" id="gender" disabled="disabled">
                           </div>
                        </div>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-8">
                        <input  value="{{ $manageoppatientslist->disease_name }}" required="required" type="text" class="form-control" name="gender" id="gender" disabled="disabled">

                     </div>
                  </div>

                       <div class="form-group row">
                     <label for="disease_id" class="col-sm-4 col-form-label"><span style="color:red"></span>IP/OP</label>
                     <div class="col-sm-8">
   ...
   <div class="form-group row">
      <label for="dist_id" class="col-sm-4 col-form-label"><span style="color:red"></span> Blocks & Rooms</label>
      <div class="col-sm-3">
         <select class="form-control select2bs4" name="block_id" id="block" style="width: 100%;" required="required">
            <option value="">Select Block Name</option>
            @foreach($manageblocks as $key=>$manageblock)
            <option value="{{ $manageblock->id }}">{{ $manageblock->block_name }}</option>
            @endforeach
         </select>
      </div>
      <div class="col-sm-3">
         <select class="form-control select2bs4" name="room_id" id="room" style="width: 100%;" required="required">
            <option value="">Select Rooms</option>
         </select>
      </div>

      <div class="col-sm-2">
         <select class="form-control select2bs4" name="bed_id" id="bed" style="width: 100%;" required="required">
