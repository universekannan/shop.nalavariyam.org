     ...
     <!-- Edit foam 2-->
                 ...
                 <div class="tab-pane fade" id="custom-tabs-four-order" 
                  ...
                  <table id="example3" class="table table-bordered table-hover">
                     ...
                     <tbody>
                        @foreach($manageorder as $key=>$manageorder)
                        <tr id="arrayorder_<?php echo $manageorder->product_id?>">
                           <td>{{ $key + 1 }}</td>  
                           <td>{{ $manageorder->product_id }}</td>  
                           <td>{{ $manageorder->mini_order_qty }}</td>
                           <td>{{ $manageorder->order_qty }}</td>
                           <td>{{ $manageorder->order_date }}</td>
                           <td>
                           ...
                           <td>   
                              <a type="button" data-toggle="modal" data-target="#stock{{ $manageorder->product_id }}">
                              <i class="fa fa-eye"></i></a>                      
                           </td>
                        </tr>
                        <div class="modal fade"id="stock{{ $manageorder->product_id }}">
                           <form action="{{url('stock')}}" method="post">
                              ...
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" class="form-control" name="product_id" 
                                          value="{{ $manageorder->product_id }}"/>
                                       <div class="form-group row">
                                          <label for="order qty" class="col-sm-4 col-form-label">
                                          <span style="color:red"></span>Order Qty</label>
                                          <div class="col-sm-8">
                                             <input value="{{ $manageorder->order_qty  }}" required="required" 
                                                type="text" class="form-control" 
                                                 id="order qty" maxlength="50" 
                                                placeholder="order_qty" readonly>
                                          </div>
                                       </div>
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-sm-8">
                                             <input value="{{ $manageorder->quantity  }}" required="required" 
                                                type="text" class="form-control" 
                                                name="qty" id="qty" maxlength="50" 
                                                placeholder="order_qty"  readonly >
                                          </div>
                                       </div> 
                                       ...
                                       <div class="form-group row">
                                          <label for="order qty" class="col-sm-4 col-form-label">
                                          <span style="color:red"></span>Reached QTY</label>
                                          <div class="col-sm-8">
                                             <input required="required" 
                                                type="text" class="form-control" 
                                                name="reac" id="reac" maxlength="50"
                                                placeholder="Reached QTY">
                                          </div>
                                       </div>  
                                       <div class="modal-footer justify-content-between">
                                          <button type="button" 
